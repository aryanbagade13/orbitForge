...
This is the pre-refactor README, retained as history. Paths and status below
may be outdated. Use the root README for the current workflow and
`legacy/README.md` for runnable archived experiments.
